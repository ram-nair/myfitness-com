        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <?php $user = Auth::user(); ?>
                    <div class="btn-group">
                        @if($user->hasRole('super-admin') || $user->hasPermissionTo('servicetype2product_create'))
                            <a href="{{ asset('/imports/service_products_type_2.xlsx') }}" download class="btn btn-success btn-sm"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Download Sample Data</a>
                            <span aria-hidden="true">&nbsp;&nbsp;</span>
                            <a href="#" data-toggle="modal" data-target="#importModal" class="btn btn-success btn-sm">Import Products</a>
                            <span aria-hidden="true">&nbsp;&nbsp;</span>
                            <a href="{{ route('admin.service-products.create',['id'=>2]) }}" class="btn btn-success btn-sm">New Product</a>
                             &nbsp;<a href="{{ route('admin.audits.activityLog','service_type_2') }}" class="btn btn-success btn-sm">View Audit Log</a>
                        @endif
                    </div>
                </div>
                <!-- /. tools -->
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{ Form::open(array('route' => array('admin.service-products.import-type-two'), 'method' => 'POST', 'class' => 'class-create', 'enctype' => 'multipart/form-data')) }}
                    <div class="card card-outline card-info">
                        <div class="overlay" style="display: none;">
                            <i class="fas fa-2x fa-sync-alt fa-spin"></i>
                        </div>
