<div class="card card-outline card-info">
    ...
    <div class="card-body pad">
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    {{ Form::label('max person', 'Max Person') }}
                    {{ Form::text('max_person', null, array('required'=>'','class' => 'form-control'.($errors->has('max_person') ? ' is-invalid' : '' ))) }}
                    {!! $errors->first('max_person','<p class="text-danger"><strong>:message</strong></p>') !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    {{ Form::label('max hour', 'Max Hour') }}
                    {{ Form::text('max_hour', null, array('required'=>'','class' => 'form-control'.($errors->has('max_hour') ? ' is-invalid' : '' ))) }}
                    {!! $errors->first('max_hour','<p class="text-danger"><strong>:message</strong></p>') !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    {{ Form::label('bring material charge', 'Bring Material Charge') }}
                    {{ Form::text('bring_material_charge', null, array('class' => 'form-control')) }}
                </div>
            </div>
            {{-- <div class="col">
