                        ...
                        @include('includes.admin.form-both')  
												...
												<div class="row">
													...
													<div class="col-lg-7">
							                           @php 
							                           if($data->user_id){
				                                      $ven = App\Models\User::where('id','=',$data->user_id)->first();  
				                                       echo $ven->name;
				                                      }else{
				                                         echo "--";
				                                    }
			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> Upload Image Here
												...
												<div class="row">
													...
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">commission*</h4>
																<p class="sub-heading">(In % only)</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="admin_commission" type="text" class="input-field" placeholder="20%" value="{{$data->admin_commission}}" >
													</div>
												</div>
												 ...
												 <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">Scheduled Delivery(in Hours)</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input  name="delivery_date" type="text" class="input-field datepicker" placeholder="Enter Scheduled Delivery(in Hours)"  value="{{$data->delivery_date}}"> 
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">Allow Cancellation</h4>
																<p class="sub-heading">(Optional)</p>
														</div>
													</div>
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_cancel" value="1" class="checkclick" id="allowCacncalation" {{ $data->is_cancel == 0 ? '' : 'checked' }}>
							                             
							                            </div>
													</div>
												</div>
												
												<div class="{{ $data->is_cancel == 0 ? 'showbox' : '' }}">

                                                <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">Cancel in Hours</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input  name="cancel_hr" type="text" class="input-field" placeholder="Enter Cancellation time" value="{{$data->cancel_hr}}">
													</div>
												</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">Allow Return</h4>
																<p class="sub-heading">(Optional)</p>
														</div>
													</div>
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_return" value="1" class="checkclick" id="allowReturn" {{ $data->is_return == 0 ? '' : 'checked' }}>
							                             
							                            </div>
													</div>
												</div>
												
												<div class="{{ $data->is_return == 0 ? 'showbox' : '' }}">
													<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">Return in Hours</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input  name="return_date" type="text" class="input-field" placeholder="Enter Return in  days"  value="{{$data->return_date}}">
													</div>
												</div>
											  </div>
											 ...
											 <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">Is customizable</h4>
																<p class="sub-heading">(Optional)</p>
														</div>
													</div>
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
														 <input type="checkbox" name="is_custom" value="1" class="checkclick" id="allowReturn" {{ $data->is_custom == 0 ? '' : 'checked' }}>
							                            
							                             
							                            </div>
													</div>
												</div>
												<div class="{{ $data->is_custom == 0 ? 'showbox' : '' }}">
													<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">Custom Fields</h4>
														</div>
													</div>
													<div class="col-lg-7">
													<select name="custom_text"> 
														<option value="1" {{$data->custom_text == 1 ? 'selected':''}}>Message/Text</option>
														<option value="2" {{$data->custom_text == 2 ? 'selected':''}}>Image</option>
														<option value="3" {{$data->custom_text == 3 ? 'selected':''}}>Both</option>													
                                            ...
                                            <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">COD Available</h4>
																<p class="sub-heading">(Optional)</p>
														</div>
													</div>
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_cod" value="{{$data->is_cod}}" class="checkclicky" id="allowCOD"  {{ $data->is_cod == 0 ? '' : 'checked' }}>
											 ...
											 <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                           <div class="checkbox-wrapper">
															<input type="checkbox" name="featured" class="checkclicks" id="featured" value="1" {{ $data->featured == null ? '' : 'checked' }}>
												 ...
												 <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                           <div class="checkbox-wrapper">
															<input type="checkbox" name="best" class="checkclicks" id="best" value="1" {{ $data->best == null ? '' : 'checked' }}>
												 ...
												 <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                           <div class="checkbox-wrapper">
															<input type="checkbox" name="top" class="checkclicks" id="top" value="1" {{ $data->top == null ? '' : 'checked' }}>
												 ...
												 <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                           <div class="checkbox-wrapper">
															<input type="checkbox" name="latest" class="checkclicks" id="top" value="1" {{ $data->latest == null ? '' : 'checked' }}>
