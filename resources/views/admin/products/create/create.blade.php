								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="geniusform" action="{{route('admin.products.store')}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
...
<div class="row">
											...
											<div class="showbox">
                                              ...
                                              <div class="row">
													...
													<div class="col-lg-7">
														<input  name="delivery_date" type="text" class="input-field" placeholder="Minimum delivery time(Hrs)">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_cancel" value="1" class="checkclick" id="allowCacncalation" >
                                                ...
                                                <div class="row">
													...
													<div class="col-lg-7">
														<input  name="cancel_hr" type="text" class="input-field" placeholder="Enter Cancel time in hrs">
													</div>
												</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_return" value="1" class="checkclick" id="allowReturn">
												...
												<div class="showbox">
													...
													<div class="col-lg-7">
														<input  name="return_date" type="text" class="input-field" placeholder="Enter Return in Hours">
													</div>
												</div>
											  </div>
											  ...
											  <div class="row">
													...
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_custom" value="1" class="checkclick" id="allowReturn">
												...
												<div class="showbox">
													...
													<option value="1">Message/Text</option>
                                            ...
                                            <div class="row">
													...
													<div class="col-lg-7">
							                            ...
							                            <div class="checkbox-wrapper">
							                              <input type="checkbox" name="is_cod" value="1" class="checkclicky" id="allowCOD" >
