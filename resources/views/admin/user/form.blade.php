        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('first_name', null, array('class' => 'form-control'.($errors->has('first_name') ? ' is-invalid' : ''))) }}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('phone', null, array('class' => 'form-control'.($errors->has('phone') ? ' is-invalid' : ''))) }}
