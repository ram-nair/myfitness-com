										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{route('admin-prod-feature',$data->id)}}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in {{ $langg->lang26 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in  {{ $langg->lang27 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in  {{ $langg->lang28 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in  {{ $langg->lang29 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in  {{ $langg->lang30 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in {{ $langg->lang31 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in {{ $langg->lang32 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in {{ $langg->lang33 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">Highlight in {{ $langg->lang244 }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-6">
														<div class="left-area">
																<h4 class="heading">Discount Date *</h4>
														</div>
													</div>
									                  <div class="col-sm-6">
									                      <input type="text" class="input-field" name="discount_date"  placeholder="Enter Date" id="discount_date" value="{{ $data->discount_date }}">
