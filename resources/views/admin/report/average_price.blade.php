    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                {{--</div>--}}
                {{ Form::open(array('url' => 'admin/download-average-price-report', 'enctype' => 'multipart/form-data')) }}
                ...
                <div class="card-body pad">
                    ...
                    @endif
                    <table class="table table-striped table-bordered dt-responsive nowrap" style="width:100%" id="average-price-table">
                        <thead>
                        <tr>
                            <th>Store Name</th>
                            <th>Store Type</th>
...
@section('js')
    ...
    $url = url($guardname.'/report-average-price/dt');
    ?>
    <script type='text/javascript'>
        $(function () {
            var oTable = $('#average-price-table').DataTable({
                processing: true,
                serverSide: true,
                ordering: false,
                //autoWidth: false,
                ...
                columns: [
                    ...
                    {data: 'recurring_customer', name: 'recurring_customer'}
