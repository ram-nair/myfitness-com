    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-info">
                ...
                {{--</div>--}}
                {{ Form::open(array('url' => 'admin/download-purchase-history-report', 'enctype' => 'multipart/form-data')) }}
                    ...
                    @if($guard_name == 'admin')
                        <div class="row">
                            ...
                            <div class="form-group col-2">
                                ...
                                <select name="payment_status" id="payment_status_filter" class="form-control select2">
...
@section('js')
    ...
    $url = url($guardname.'/report-purchase-history/dt');
    ?>
    <script type='text/javascript'>
        $(function () {
            var oTable = $('#canceled-order-table').DataTable({
                ...
                ajax: {
                    ...
                    data: function ( d ) {
                        ...
                        if( $('#payment_status_filter').val() != undefined) {
            ...
            $(document).on("change", "#store_filter, #payment_type_filter, #order_type_filter, #payment_status_filter", function() {
                oTable.ajax.reload();
            });
        });
    </script>
