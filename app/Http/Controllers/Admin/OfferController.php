    ...
    public function datatable(Request $request)
    {
        ...
        return Datatables::of($offers)
            ...
            ->editColumn('actions', function ($offers) use ($currentUser) {
                ...
                if ($currentUser->hasPermissionTo('offerproduct_read')) {
                    $deleteUrl = \URL::route('admin.offer-products.index');
                    $b .= ' <a href="' . $deleteUrl . '" class="btn btn-outline-success btn-xs">Manage Product</a>';
